...
{
	if(argc < 5){
	fprintf(stderr, "w00dy private butt plunger [CN-WARS]\n");
	...
	int i = 0;
	head = NULL;
	fprintf(stdout, "Putting on socks...\n");
	int max_len = 128;
	...
	fprintf(stdout, "Getting out of bed...\n");
