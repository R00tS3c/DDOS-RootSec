...
Yet another bloody UDP insecure service, this time similar to other abused SOAP
protocols but needing no trigger payload. Shodan showed 216,313 possible
reflectors with the largest count from Vietnam followed by United States.
-------------------------------*/
#include <arpa/inet.h>
