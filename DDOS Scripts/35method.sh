#!/bin/bash
#    Setup UDP, TCP, & Amplification Based Attack/Scanner Scripts
#
#    Installed Methods:
...
#
if [ $# != 1 ]; then
echo "RootSec - Script Wget & Compiler (35 Methods)"
...
while test $# -gt 0; do
        case "$1" in
				...
				gcc sentinelscan.c -lpthread -lpcap -o sentinelscan
				...
				gcc db2scan.c -lpthread -lpcap -o db2scan
